...
const translations = {
  ...
  en: {
    ...
    options: [
      ["Quiet place in nature", "Trendy café in the city", "Weird or dark place"],
...
export default function PersonalityQuiz() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 font-sans">
      ...
      {!result ? (
        <div className="shadow-xl border-0 rounded-xl animate-fade-in bg-white">
        ...
        <div className={`${results[result].color} rounded-2xl shadow-2xl border-none animate-fade-in`}>
